...
<p>This is a collect of links for tools and resources related to Java and Spring development.</p>
...
<ul>
    ...
    <li><a href="http://stackoverflow.com/questions/tagged/spring">Spring Question on StackOverflow</a></li>
